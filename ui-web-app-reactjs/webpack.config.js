...
module.exports = (env, argv) => ({
  ...
  */
    ...
    */
    !env.prod && new AfterCompilePlugin({
      run: () => {
        ...
        console.log(`💻  => Application running in browser at http://18.206.251.148:${DEV_SERVER_PORT}\n\n`)
      }
    })
  ].filter(Boolean),
  ...
  devServer: {
    ...
    */
    public: `http://18.206.251.148:${DEV_SERVER_PORT}`,
    ...
    */
    proxy: API_WEBPACK ? {
      [API_WEBPACK]: {
        target: `http://18.206.251.148:${API_PORT}`,
